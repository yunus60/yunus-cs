...
subprojects {
    ...
    dependencies {
        ...
        implementation("com.fasterxml.jackson.module:jackson-module-kotlin:2.17.3")   // Kotlin için Jackson JSON kütüphanesi
        implementation("com.fasterxml.jackson.core:jackson-databind:2.17.3")          // JSON-nesne dönüştürme kütüphanesi
